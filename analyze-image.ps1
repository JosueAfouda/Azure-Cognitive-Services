$key="5dd748ea8b064171b802813c91b9616a"
$endpoint="https://josh-explore-computer-vision.cognitiveservices.azure.com/"
...
$img = "https://raw.githubusercontent.com/JosueAfouda/Azure-Cognitive-Services/main/data/vision/$img_file"
